		...
		<c:forEach items="${booktwo}" var="book">
			<div class=second_c_02_b1_1>
				<a href='${pageContext.request.contextPath}/book/selectOneBook?id=${book.id }' target='_blank'>
					<img class="aa" src="${pageContext.request.contextPath}/back/img/${book.cover}" width=70 border=0 />
				</a>
			</div>
			<div class=second_c_02_b1_2>
				<h3>
					<a href='${pageContext.request.contextPath}/book/selectOneBook?id=${book.id }' target='_blank' >${book.name }</a>
				</h3>
				<h4>
					作者：${book.author }著
					<br />
